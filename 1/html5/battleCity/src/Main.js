...
function initTouchEvent()
{
	...
	gameDiv.ontouchstart = function(e){
		e.preventDefault();
	...
	up.ontouchstart = function(e){
		e.preventDefault();
		key[K_UP] = true;
	}
	up.ontouchend = function(e){
		key[K_LEFT] = false;
		key[K_RIGHT] = false;
		key[K_UP] = false;
		key[K_DOWN] = false;
	...
	down.ontouchstart = function(e){
		e.preventDefault();
		key[K_DOWN] = true;
	}
	down.ontouchend = function(e){
		key[K_LEFT] = false;
		key[K_RIGHT] = false;
		key[K_UP] = false;
		key[K_DOWN] = false;
	...
	fire.ontouchstart = function(e){
		e.preventDefault();
		key[K_SPACE] = true;
	}
	fire.ontouchend = function(e){
		key[K_SPACE] = false;
	}
}
...
{
	time = -20;
	touchxy = {x:gameDiv.getBoundingClientRect().left, y:gameDiv.getBoundingClientRect().top};
