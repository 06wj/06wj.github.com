...
var hitGround = new Bitmap(0, 0, "d", 1707, 400);
...
Ground.prototype.draw = function()
{
	...
	{
		context.drawImage(this.img, this.x, this.y, 550, this.img.height, 0, 400 - this.height, 550, this.height);
	}
	else
	{
		var temp = this.x - (this.img.width - 550);
		context.drawImage(this.img, this.x, this.y, 550 - temp, this.img.height, 0, 400 - this.height, 550 - temp, this.height);
		context.drawImage(this.img, 0, this.y, temp, this.img.height, 550 - temp, 400 - this.height, temp, this.height);
	}
}
...
//var ground = new Ground(0, 0, "d", 550, 400);
var ground = new Ground(0, 0, "c", 550, 320);
