(function(c){var b=c.Quark=c.Quark||{version:"1.0.0",global:c},a=function(){};b.inherit=function(b,g){a.prototype=g.prototype;b.superClass=g.prototype;b.prototype=new a;b.prototype.constructor=b};b.merge=function(a,b,d){for(var c in b)if(!d||a.hasOwnProperty(c))a[c]=b[c];return a};b.delegate=function(a,b){var d=b||c;if(arguments.length>2){var e=Array.prototype.slice.call(arguments,2);return function(){var b=Array.prototype.concat.apply(e,arguments);return a.apply(d,b)}}else return function(){return a.apply(d,
